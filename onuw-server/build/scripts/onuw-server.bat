...
set CLASSPATH=%APP_HOME%\lib\onuw-server.jar;%APP_HOME%\lib\guava-23.0.jar;%APP_HOME%\lib\javax.websocket-api-1.1.jar;%APP_HOME%\lib\jackson-databind-2.9.8.jar;%APP_HOME%\lib\javax.servlet-api-3.1.0.jar;%APP_HOME%\lib\jsr305-1.3.9.jar;%APP_HOME%\lib\error_prone_annotations-2.0.18.jar;%APP_HOME%\lib\j2objc-annotations-1.1.jar;%APP_HOME%\lib\animal-sniffer-annotations-1.14.jar;%APP_HOME%\lib\jackson-annotations-2.9.0.jar;%APP_HOME%\lib\jackson-core-2.9.8.jar
